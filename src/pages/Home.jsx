        ...
        {show1 &&
          <div className={show1 ? 'terryStoneContainer animation' : 'terryStoneContainer'}>
            ...
            <div className='terryStoneTextContainer'>
              ...
              <p className='terryText'>“TALES FROM THE TRAP (“TFT<span>T</span>”) Film &amp; Television Franchise will leverage from the anticipated exponential growing demand of digital assets in the Film, Television, social media, music and the graphic/art content industries.</p>
